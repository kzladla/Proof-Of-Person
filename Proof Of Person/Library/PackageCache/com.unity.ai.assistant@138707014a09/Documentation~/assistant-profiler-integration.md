---
uid: assistant-profiler-integration
---
...
| Topic | Description |
| ----- | ----------- |
| [Analyze profiler data from Assistant](xref:analyze-performance-assistant) | Start in the Assistant window, ask performance-related questions, and analyze the available profiling sessions without opening the Profiler first. |
| [Analyze profiler data from Unity Profiler](xref:use-profiler) | Start in the Profiler window, select specific samples or frames, and send them to Assistant for targeted analysis and explanation. |

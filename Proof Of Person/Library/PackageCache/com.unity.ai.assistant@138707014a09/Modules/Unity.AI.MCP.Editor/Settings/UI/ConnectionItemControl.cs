...
namespace Unity.AI.MCP.Editor.Settings.UI
{
    ...
    class ConnectionItemControl : VisualElement
    {
        ...
        void UpdateActionButtons()
        {
            ...
            // Pending: Show Accept/Deny actions view
            // Rejected: Also show Accept to allow re-approval
            m_ActionsView.style.display = (isPending || isRejected) ? DisplayStyle.Flex : DisplayStyle.None;

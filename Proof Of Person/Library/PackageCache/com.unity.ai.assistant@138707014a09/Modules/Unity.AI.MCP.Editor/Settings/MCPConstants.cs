...
namespace Unity.AI.MCP.Editor.Settings
{
    ...
    static class MCPConstants
    {
        ...
        /// </summary>
        public const string projectSettingsPath = "Project/AI/MCP Server";
        ...
        /// <summary>
        /// Gets the path to the relay binary (bundled with the package)
        /// </summary>
        public static string InstalledServerMainFile
        {
            get
            {
                ...
                {
                    // Use arm64 or x64 based on architecture

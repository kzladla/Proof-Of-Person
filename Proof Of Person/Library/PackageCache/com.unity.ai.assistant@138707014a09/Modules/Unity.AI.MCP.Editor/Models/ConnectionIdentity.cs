...
namespace Unity.AI.MCP.Editor.Models
{
    ...
    class ConnectionIdentity
    {
        ...
        public static ConnectionIdentity FromConnectionInfo(ConnectionInfo connectionInfo)
        {
        ...
        public bool MatchesConnectionInfo(ConnectionInfo connectionInfo)
        {
            if (connectionInfo == null)
                return false;
        ...
        public string GetDisplayDescription(ConnectionInfo connectionInfo)
        {
            if (connectionInfo == null)

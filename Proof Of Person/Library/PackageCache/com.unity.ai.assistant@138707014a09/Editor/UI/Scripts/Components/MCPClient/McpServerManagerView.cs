...
namespace Unity.AI.Assistant.UI.Editor.Scripts.Components
{
    ...
    class McpServerManagerView : ManagedTemplate
    {
        ...
        const string k_TroubleshootingDocsUrl = "https://docs.unity.com/TODO-mcp-troubleshooting";
        ...
        Label m_InspectorServerMessage;
        ...
        protected override void InitializeView(TemplateContainer view)
        {
            ...
            var configFilePathTextField = view.Q<TextField>("configFilePathTextField");
            configFilePathTextField.value = System.IO.Path.GetFullPath(McpServerConfigUtils.GetConfigFilePath());
            ...
            m_InspectorServerMessage = view.Q<Label>("inspectorServerMessage");
            ...
            view.SetupButton("editConfigButton", _ => McpServerConfigUtils.OpenConfigFileInEditor());
        }
        ...
        void UpdateServerInspector()
        {
            ...
            m_InspectorServerMessage.text = string.IsNullOrEmpty(stateData.Message) ? "No message" : stateData.Message;

...
namespace Unity.AI.Assistant.Editor
{
    ...
    static class ProviderStateObserver
    {
        ...
        /// <summary>
        /// Returns true if the current provider is not supported on the current platform.
        /// Currently, Cursor is not supported on Windows.
        /// </summary>
        public static bool IsProviderUnsupportedOnCurrentPlatform
        {
            get
            {
                ...
                return string.Equals(s_CurrentProviderId, "cursor", StringComparison.OrdinalIgnoreCase);
            }
        }
